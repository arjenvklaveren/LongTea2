        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                float4 outputPosition = o.vertex;
                outputPosition.y += sin(((v.vertex.x + v.vertex.z) * 3.0 + _Time) * 20.0) * 3.0;
                o.worldPos = TransformObjectToWorld(v.vertex);

                float3 ddxPos = ddx(outputPosition);
                float3 ddyPos = ddy(outputPosition);
